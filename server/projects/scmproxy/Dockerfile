...
ARG EXTRA_TOOLS="gnupg curl wget jq net-tools procps default-libmysqlclient-dev locales inotify-tools gcc git subversion telnet iputils-ping vim openssh-client"
