...
repos_url_patterns = [
    ...
    path("<int:repo_id>/projects/<int:project_id>/scans/", v1_pt.PTAnalyseServerProxyApi.as_view(),
         name="apiv1_pt_project_scans"),
    path("<int:repo_id>/projects/<int:project_id>/scans/<int:scan_id>/", v1_pt.PTProjectScanDetailApiView.as_view(),
         name="apiv1_pt_repo_project_scan_info"),
    path("<int:repo_id>/projects/<int:project_id>/scans/<int:scan_id>/qualityreport/",
         v1_pt.PTAnalyseServerProxyApi.as_view(),
         name="apiv1_pt_project_scan_qualityreport"),
    path("<int:repo_id>/projects/<int:project_id>/overview/", v1_pt.PTAnalyseServerProxyApi.as_view(),
         name="apiv1_pt_project_overview"),
    path("<int:repo_id>/projects/<int:project_id>/overview/latestscan/", v1_pt.PTAnalyseServerProxyApi.as_view(),
         name="apiv1_pt_project_latestscan_overview"),
    path("<int:repo_id>/projects/<int:project_id>/overview/lintscans/", v1_pt.PTAnalyseServerProxyApi.as_view(),
         name="apiv1_pt_project_lintscans_overview"),
    path("<int:repo_id>/projects/<int:project_id>/overview/cycscans/", v1_pt.PTAnalyseServerProxyApi.as_view(),
         name="apiv1_pt_project_cycscans_overview"),
    path("<int:repo_id>/projects/<int:project_id>/overview/dupscans/", v1_pt.PTAnalyseServerProxyApi.as_view(),
         name="apiv1_pt_project_dupscans_overview"),
    path("<int:repo_id>/projects/<int:project_id>/overview/clocscans/", v1_pt.PTAnalyseServerProxyApi.as_view(),
         name="apiv1_pt_project_clocscans_overview"),
    path("<int:repo_id>/projects/<int:project_id>/overview/scorescans/", v1_pt.PTAnalyseServerProxyApi.as_view(),
         name="apiv1_pt_project_scorescans_overview"),
    path("<int:repo_id>/projects/<int:project_id>/codelint/issues/", v1_pt.PTAnalyseServerProxyApi.as_view(),
         name="apiv1_pt_project_codelint_issue"),
    path("<int:repo_id>/projects/<int:project_id>/codelint/issues/epreport/", v1_pt.PTAnalyseServerProxyApi.as_view(),
         name="apiv1_pt_project_codelint_issue_epreport"),
    path("<int:repo_id>/projects/<int:project_id>/codelint/issues/summary/", v1_pt.PTAnalyseServerProxyApi.as_view(),
    ...
    path("<int:repo_id>/projects/<int:project_id>/scheme/defaultpaths/",
         ...
         name="apiv1_tiyan_project_scheme_defaultpaths"),
    path("<int:repo_id>/projects/<int:project_id>/scans/jobconfs/",
         v1_pt.PTProjectScanJobConfApiView.as_view(),
         name="apiv1_tiyan_project_scan_jobconfs"),
    path("<int:repo_id>/projects/<int:project_id>/scans/<int:scan_id>/",
         v1_pt.PTProjectScanDetailApiView.as_view(),
         name="apiv1_tiyan_project_scan_detail"),
