import{_ as t,o as e,c as i,e as u}from"./app-91787dbd.js";const n={},d=u(`<h1 id="代码扫描数据管理" tabindex="-1"><a class="header-anchor" href="#代码扫描数据管理" aria-hidden="true">#</a> 代码扫描数据管理</h1><h2 id="查看扫描问题列表" tabindex="-1"><a class="header-anchor" href="#查看扫描问题列表" aria-hidden="true">#</a> 查看扫描问题列表</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>GET /server/analysis/api/orgs/&lt;org_sid&gt;/teams/&lt;team_name&gt;/repos/&lt;repo_id&gt;/projects/&lt;project_id&gt;/codelint/issues/
